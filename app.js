    ...
    <div class="container">
        <header>
            <div class="telegram-logo">
                <img src="/images/tele_robo_chatbot.png" alt="Telegram Bot Logo" style="width: 120px; height: auto;">
            </div>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <img src="/images/standup_profile_pic.jpg" alt="Bot Profile" style="max-width: 200px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
        </div>
